...
class ProductReview(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='reviews') #  on_delete=models.CASCADE diye user delete koyar sathe sathe product delete hoye jabe.  related_name='reviews' reated name ta revers relationship er modhe pore. related name er modhe jeta thake oita diye ke kon product er review ba er sathe relation ache ta khuje ber kora jay 
